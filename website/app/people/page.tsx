...
export default function PeoplePage() {
  ...
  return <PageFrame>
    ...
    <section className="section-shell pi-profile">
      ...
      <dl className="profile-facts"><div><dt>2025–present</dt><dd>Department Chair</dd></div><div><dt>2022–present</dt><dd>Assistant Professor, Dong Seoul University</dd></div><div><dt>2014–2022</dt><dd>Senior Researcher, Agency for Defense Development</dd></div><div><dt>2014</dt><dd>Ph.D., Electrical & Electronic Engineering, Yonsei University</dd></div></dl>
    </section>
